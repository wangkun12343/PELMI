...
if __name__ == "__main__":
    ...
    read_file_path = os.path.join(root_path, "data", "pictures", "Lisa.jpg")
    write_file_path = os.path.join(generated_file_path, "target1.jpg")
    temp_model_path = os.path.join(generated_file_path, "model.pkl")
    dna_path = os.path.join(generated_file_path, "target_Goldman.dna")
